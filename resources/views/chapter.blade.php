...
<x-app-layout>
    ...
    @if(Auth::permition()->edit_content == "1" && !$edit)
    <div class="d-inline-block w-100 edit-bar" style="margin-top: -2rem;">

        <div class="d-flex float-end p-2 edit-box me-4">

            <div class=" edit-box-icon su-opacity-60" onclick="this.classList.add('rotating-1'), this.children[0].classList.remove('setting-menu-gear'), setTimeout(function (){location.href = window.location.pathname +'/edit'},100)">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-gear-fill setting-menu-gear" name="setting" viewBox="0 0 16 16">
