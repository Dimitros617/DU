...
>
    ...
    @endif
        ...
        @endphp
        <button class="su-button text-center p-3 w-100 mx-auto d-grid" @if(!$edit && $element->data != null)onclick="finishTest(this.parentNode, '{{$element->data}}', this.getElementsByClassName('loading')[0], this.getElementsByClassName('loading_request')[0])"@endif>
