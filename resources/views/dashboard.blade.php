                    ...
                    <div class="chapter_box ">
                        ...
                        @foreach($books as $book)
                            ...
                            <a @if(Auth::permition()->edit_content == "1")
                                onclick="if(this.children[0] == event.target)checkLock({{$book->id}},'books',this.getElementsByClassName('loading')[0],this.getElementsByClassName('loading_request')[0], '/chapters/{{$book->id}}',this.children[0].children[0].value )"
                               @else
                                onclick="checkLock({{$book->id}},'books',this.getElementsByClassName('loading')[0],this.getElementsByClassName('loading_request')[0], '/chapters/{{$book->id}}',this.children[0].children[0].value )"
                               @endif
                        ...
                        <div class="chapter_img" style="background-image: url('{{$book->img}}');" >
                            ...
                            <div class="gray-box">
                                ...
                                <div class="status status-icon">
                                    <svg onclick=" setTimeout(function (spinner){getStatus(spinner,'/get_book_status/{{$book->id}}')},50,this.parentNode.parentNode.parentNode.parentNode.parentNode.getElementsByClassName('loading')[0]); return false" title="Přehled žáků" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lightbulb-fill" viewBox="0 0 16 16">
