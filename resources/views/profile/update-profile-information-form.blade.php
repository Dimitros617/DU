...
<x-jet-form-section submit="updateProfileInformation">
    ...
    <!-- Name -->
        ...
        <!-- Přezdívka -->
        <div class="col-span-6 sm:col-span-4 " >
            <x-jet-label for="nick" disabled value="{{ __('Přezdívka') }}" />
            <x-jet-input id="nick" disabled type="text" class="mt-1 block w-full" wire:model.defer="state.nick" autocomplete="nickname" />
