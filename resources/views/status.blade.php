<div class="pageTitle mt-2">Postup žáků</div>
...
<div class="List">
     ...
     @foreach($data as $dat)
        <div class="status-row d-flex flex-column flex-xl-row d-md-inline-flex flex-md-nowrap w-100 mx-auto mb-3 justify-content-between bg-su-blue-orange-gradient rounded-3 shadow p-5" style="    border-left: 10px solid #ff9f1c;">

            <div class="status-name fw-bold h1 text-su-blue text-su-shadow-white" style="line-height: 200%;"><a href="/users/{{$dat->user_id}} " class="text-decor-none">{{$dat->name}} {{$dat->surname}}</a></div>

            <div class="status-visited d-grid mb-5 mb-xl-0">
            ...
            <div class="status-last d-grid mb-5 mb-xl-0">
            ...
            <div class="status-locked d-grid mb-5 mb-xl-0">
            ...
            <div class="status-finished d-grid mb-5 mb-xl-0">
