...
" userID="{{$user->userId}}">
                            ...
                            @if(Auth::permition()->new_user == 1)
                                <div class="p-0 buttonsDivItem">
                                    ...
                                    <div class="p-0 buttonsDivItem">
                                        <svg onclick=" setTimeout(function (ele,id){getStatusChapter(ele, id)},50,this,{{$user -> userId}}); return false" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-lightbulb-fill text-danger" viewBox="0 0 16 16">
